...
class MapLULCPage extends SampleView {
  /// Creates the polygon map sample
  const MapLULCPage(Key key) : super(key: key);

  @override
  _MapLULCPageState createState() => _MapLULCPageState();
}

class _MapLULCPageState extends SampleViewState {
                  ...
                  if (index == 0) {
                    ...
                    _zoomPanBehavior
                      ...
                      ..focalLatLng = const MapLatLng(
                          0.15336727579496373, 36.43277553692863);
                  } else if (index == 1) {
                    _boundaryJson = 'assets/Marmanet-whole.json';
  ...
  void initState() {
    _polygonData = <PolygonDataModel>[
      PolygonDataModel('Fit', 'images/sparkline_winloss.png',
