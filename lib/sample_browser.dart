...
class _SampleBrowserState extends State<SampleBrowser> {
  ...
  Widget build(BuildContext context) {
    final Map<String, WidgetBuilder> navigationRoutes = <String, WidgetBuilder>{
      _sampleListModel.isWebFullView ? '/' : '/home': (BuildContext context) =>
          const HomePage()
    };
    ...
    return _sampleListModel.isWebFullView
        ? MaterialApp(
            ...
            title: 'Forest Inventory Administrator Dashboard',
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              const Padding(
                                ...
                                child: Text('Forest Inventory Admin ',
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 28,
                                        letterSpacing: 0.53,
                              ...
                              const Padding(
                                  ...
                                  child: Text('With Automated RS Functions',
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 14,
