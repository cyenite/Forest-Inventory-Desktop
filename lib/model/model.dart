...
class Control {
  ...
  /// Need to mention this when modules directly given without any sub category
...
class SampleModel extends Listenable {
  ...
  Color backgroundColor = const Color.fromRGBO(2, 137, 123, 1);

  /// holds light theme current palette color
  Color paletteColor = const Color.fromRGBO(2, 137, 123, 1);

  /// holds current palette color
  /// on toggling the palette colors before or after apply settings
  Color currentPrimaryColor = const Color.fromRGBO(0, 137, 123, 1);
  ...
  Color currentPaletteColor = const Color.fromRGBO(2, 137, 123, 1);
